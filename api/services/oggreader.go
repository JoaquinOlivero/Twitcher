// copied from github.com/ashellunts/ffmpeg-to-webrtc/blob/audio/src/oggreader.go
...
func NewWith(in io.ReadCloser) (*OggReader, *OggHeader, error) {
	return newWith(in /* doChecksum */, true)
}

func newWith(in io.ReadCloser, doChecksum bool) (*OggReader, *OggHeader, error) {
	if in == nil {
...
// data being finished.
func (o *OggReader) ResetReader(reset func(bytesRead int64) io.ReadCloser) {
